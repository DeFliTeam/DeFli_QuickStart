...
start_button_3 = tk.Button(tab3, text="Start acarshub Service", command=lambda: start_acarshub_service("docker-compose-acarshub.yml", lat_entry_3, lon_entry_3, tz_entry_3, feed_entry, alt_entry3, running_label_3))
stop_button_3 = tk.Button(tab3, text="Stop acarshub Service", command=lambda: stop_acarshub_service("docker-compose-acarshub.yml", running_label_3))
save_button_3 = tk.Button(tab3, text="Save Changes", command=lambda: save_acarshub_changes("docker-compose-acarshub.yml", lat_entry_3.get(), lon_entry_3.get(), tz_entry_3.get(), alt_entry_3.get(), feed_entry.get()))
