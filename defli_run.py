...
start_button_1 = tk.Button(tab1, text="Start DeFli_Run Service", command=lambda: start_service("docker-compose-defli_run.yml", lat_entry, lon_entry, tz_entry, alt_entry, bucketid_entry, running_label))
...
alt_entry_2 = tk.Entry(tab2)
bucketid_entry_2 = tk.Entry(tab2)
...
start_button_3 = tk.Button(tab3, text="Start acarshub Service", command=lambda: start_service("docker-compose-acarshub.yml", lat_entry_3, lon_entry_3, tz_entry_3, feed_entry, alt_entry3, running_label_3))
stop_button_3 = tk.Button(tab3, text="Stop acarshub Service", command=lambda: stop_service("docker-compose-acarshub.yml", running_label_3))
save_button_3 = tk.Button(tab3, text="Save Changes", command=lambda: save_changes("docker-compose-acarshub.yml", lat_entry_3.get(), lon_entry_3.get(), tz_entry_3.get(), alt_entry_3.get(), feed_entry.get()))
